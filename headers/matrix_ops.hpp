...
template <typename T> bool sameCPU(const Matrix<T> &A, const Matrix<T> &B, float eps = 1e-5)
{
...
{
    // a and b's dimensions should match result dimensions either on height or width or have numels
    // 1
